# PÚRO — Plan de fotos para la página (pensado para Diego)

Orden recomendado en la landing. ✅ = ya la tenés. Las fotos de **personas** = hombres argentinos reales de 40-55, comunes (NO modelos fitness de 25) → Diego se tiene que ver reflejado.

> Tip general: subí el frasco final a ChatGPT y pedí "keep this exact bottle/label" en las que aparezca el producto. Títulos/textos largos: ponelos después en Canva.
...
Va en: sección de fórmula. Refuerza confianza y "natural".
```
Use the uploaded PÚRO bottle, keep label identical. Clean top-down flat lay on a soft white surface: the amber PÚRO bottle in the center surrounded, neatly and minimally, by its natural ingredients — maca root, ashwagandha root, a small pile of zinc/mineral capsules, dried herbs. Navy and white aesthetic, bright, premium, organized, photorealistic. 1:1.
```
...
- **Testimonios:** cuando los tengas, usá **fotos reales de clientes** (Diego desconfía de lo "demasiado prolijo").
- **ANMAT/sello:** solo cuando tengas el RNPA.
